...
class StandardsControllerTest < ActionController::TestCase
  ...
  test "should create standard" do
    assert_difference('Standard.count') do
      post :create, standard: { aroma: @standard.aroma, color: @standard.color, description: @standard.description, style: @standard.style, taste: @standard.taste }
    end
  ...
  test "should update standard" do
    patch :update, id: @standard, standard: { aroma: @standard.aroma, color: @standard.color, description: @standard.description, style: @standard.style, taste: @standard.taste }
    assert_redirected_to standard_path(assigns(:standard))
  end
